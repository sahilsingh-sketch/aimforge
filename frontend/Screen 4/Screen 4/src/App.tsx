        ...
        <div className="min-h-screen max-w-[1140px] flex mx-auto px-8 py-6 flex-col w-full">
          <div className="border-white/10 border-t-0 border-r-0 border-b-1 border-l-0 border-solid flex pb-5 justify-between items-center">
            <div className="flex items-center gap-4">
              <div className="size-12 shadow-[0_0_30px_oklch(0.646_0.222_41.116/.25)] rounded-full bg-[#f54900]/15 text-[#f54900] flex justify-center items-center">
          ...
          <div className="text-[#9f9fa9] text-sm leading-5 border-white/10 border-t-0 border-r-0 border-b-1 border-l-0 border-solid flex py-5 items-center gap-8">
            <div className="rounded-full text-neutral-50 border-[#f54900] border-t-0 border-r-0 border-b-2 border-l-0 border-solid flex px-1 pb-3 items-center gap-2">
              <LayoutDashboard className="size-4" />
              <span>Dashboard</span>
            </div>
            <div className="flex px-1 pb-3 items-center gap-2">
          ...
          <div className="grid grid-cols-[1.35fr_0.85fr] py-6 flex-1 gap-6">
                  ...
                  <div className="rounded-2xl bg-zinc-950 border-white/10 border-1 border-solid p-4">
                    <div className="flex justify-between items-center">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-medium">Micro Flicks</div>
                          <div className="text-[#9f9fa9] text-sm leading-5">
                  ...
                  <div className="rounded-2xl bg-zinc-950 border-white/10 border-1 border-solid p-4">
                    <div className="flex justify-between items-center">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <div className="font-medium">Strafe Tracking</div>
                          <div className="text-[#9f9fa9] text-sm leading-5">
                            Maintain crosshair on moving targets
                          </div>
                        </div>
                      </div>
                      <div className="text-[#9f9fa9] text-sm leading-5">
                    ...
                    <div className="flex justify-between items-center">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-[#9f9fa9] text-sm leading-5">
                            Summarize mistakes and next steps
                          </div>
                        </div>
                      </div>
                      <div className="text-[#9f9fa9] text-sm leading-5">
